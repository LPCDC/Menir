        ...
        while True:
            try:
                ...
                if pending_files:
                    ...
                    # 1. Concorrência: Envializa todos pro Event Loop simultaneamente (limitado a 10 pelo Semaphore)
                    tasks = [self._process_single_file(file_path, tenant) for file_path in pending_files]
