...
class CommandPayload(BaseModel):
    ...
    action: Literal["PAUSE_INGESTION", "RELOAD_RULES", "FLUSH_QUARANTINE", "RESUME_INGESTION", "STATUS_REPORT", "CONFIRMATION_REQUIRED", "REJECTED"] = Field(description="Strict enum of allowed engine actions.")
...
class MenirLogos:
    ...
    async def interpret_intent(self, raw_input: str, origin: str) -> CommandPayload:
        """
        ...
        if origin not in self.AUTHORITY_MATRIX:
            return CommandPayload(
                command_id="REJ_00", origin="WEB_UI", action="REJECTED",
        ...
        try:
            ...
            return CommandPayload(
                command_id="ERR_500", origin=origin, action="REJECTED",
